...
#define FWRETRACT  // MRiscoC Enabled support for firmware based retract
  ...
  #endif
  #define RETRACT_LENGTH                0.7   // (mm) Default retract length (positive value)  // MRiscoC Bowden
  #define RETRACT_LENGTH_SWAP          13   // (mm) Default swap retract length (positive value)
  #define RETRACT_FEEDRATE             10   // (mm/s) Default feedrate for retracting  // MRiscoC Bowden
  #define RETRACT_ZRAISE                0.2   // (mm) Default retract Z-raise  // MRiscoC Bowden
  #define RETRACT_RECOVER_LENGTH        0   // (mm) Default additional recover length (added to retract length on recover)
  #define RETRACT_RECOVER_LENGTH_SWAP   0   // (mm) Default additional swap recover length (added to retract length on recover from toolchange)
  #define RETRACT_RECOVER_FEEDRATE      10   // (mm/s) Default feedrate for recovering from retraction  // MRiscoC Bowden
...
//mike edited to his printer
#if ENABLED(ADVANCED_PAUSE_FEATURE)
  #define PAUSE_PARK_RETRACT_FEEDRATE         10  // (mm/s) Initial retract feedrate.
  #define PAUSE_PARK_RETRACT_LENGTH            0.7  // (mm) Initial retract.
